...
<head>
    ...
    <!-- Favicon -->
    <link rel="icon" type="image/x-icon" href="assets/img/doji white on black.ico">
    <link rel="icon" type="image/png" sizes="32x32" href="assets/img/doji white on black.png">
    <link rel="apple-touch-icon" sizes="180x180" href="assets/img/doji white on black.png">
