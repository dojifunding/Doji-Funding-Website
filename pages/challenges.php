    ...
    <div class="trust-bar-wrap" style="max-width:1200px;margin:0 auto">
        <div class="trust-bar">
            ...
            <div class="trust-item">
                ...
                <span><strong>Regulated</strong> GFSC Gibraltar</span>
            </div>
            ...
            <div class="trust-item">
                ...
                <span><strong>Instant</strong> Account Access</span>
            </div>
            <div class="trust-sep"></div>
            <div class="trust-item">
                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M3 9l9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"/><polyline points="9 22 9 12 15 12 15 22"/></svg>
                <span><strong>48h</strong> Refund Window</span>
            </div>
            <div class="trust-sep"></div>
            <div class="trust-item">
            ...
            <div class="trust-item">
                ...
                <span><strong>24/7</strong> Support During Challenge</span>
            </div>
            <div class="trust-sep"></div>
            <?php endfor; ?>
        </div>
