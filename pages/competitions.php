...
<section class="hero" style="min-height:420px;padding:90px 32px 60px">
    <!-- Particle canvas: dot-grid + rotating diamond (mouse-driven) -->
    <canvas class="hero-shape-canvas" data-shape="diamond" data-cy="0.30" data-scale="1.35" aria-hidden="true"></canvas>
